...
*PD: en el mismo codigo se adicionaron comentarios con respecto a la ejecucion del proceso. Adicional, en el main.py se adicionaron al final llamados al proceso de una fecha determinada para ser utilizados como testing*
